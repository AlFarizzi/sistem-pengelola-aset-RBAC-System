<tr>
    ...
    <td style="text-align: center;">
        <a href="#" data-asset="{{$item->no_asset}}" id="edit" style="display: inline" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> Edit</a>
