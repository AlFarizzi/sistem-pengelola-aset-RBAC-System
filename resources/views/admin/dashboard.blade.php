            ...
            <div class="page-inner py-5">
                <div
                    ...
                    <div>
                        ...
                        <h5 class="text-white op-7 mb-2"><i class="fa fa-laptop"></i> Sistem Pengelola Aset Berbasis Web</h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-stats card-round">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
                                    <div class="icon-big text-center">
                                        <i class="fas fa-clipboard-list text-warningf"></i>
                                    </div>
                                </div>
                                <div class="col-7 col-stats">
                                    <div class="numbers">
